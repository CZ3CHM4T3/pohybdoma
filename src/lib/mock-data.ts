...
export const MOCK_MEMBERSHIP_PLANS: MembershipPlan[] = [
  {
    ...
    highlighted: false,
    features: [
      "Celá videoknihovna pro členy (záda, kyčle, dech, koleno…)",
      "Kurzy krok za krokem + oblíbená videa a postup",
      "Komunita Kruhů – propojení s ostatními",
      "Chlubírna – sdílej svůj pokrok a povzbuď ostatní",
      "Můžeš napsat recenzi",
  ...
  },
  {
    ...
    features: [
      ...
      "VIP videa a pokročilé kurzy navíc",
      "Chytré filtry knihovny – najdeš přesně to svoje",
      "Můj deník – váha, bolest, energie a pokrok v grafech",
      "Členská sleva 10 % na kurzy",
    ],
  },
  {
    id: "mp3",

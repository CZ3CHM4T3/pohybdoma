...
const BASE_COURSES: Course[] = [
  ...
  },
  {
    ...
    slug: "rameno",
    title: "RAMENO",
    subtitle: "Obnov funkci a zbav se bolesti ramene",
    description:
      "Kompletní průvodce pro zdravé rameno. Vhodné po úrazech, při přetížení i jako prevence pro každého, kdo pracuje rukama nad hlavou.",
    ...
    lessons: [
      ...
      { id: "l54", order: 2, title: "Diagnostika tvého ramene", durationSeconds: 720, accessLevel: "FREE" },
...
export const MOCK_MEMBERSHIP_PLANS: MembershipPlan[] = [
  {
    ...
    highlighted: false,
    features: [
      "Celá knihovna pohybu – cvič přesně na to, co tě trápí (záda, kyčle, dech…)",
      "Rychle najdeš svoje: třídění podle části těla, obtížnosti i problému",
      "Nové lekce průběžně přibývají",
  ...
  },
  {
    ...
    tier: "VIP",
    name: "VIP",
    tagline: "Cvič s vedením a motivací",
    priceKcMonth: 399,
    highlighted: true,
    features: [
      "Vše z MEMBER",
      "Měsíční pohybová výzva – jasný plán, co a kdy cvičit (konec tápání)",
      "Živé streamy se mnou – cvič naživo a ptej se přímo",
      "Skupinová online konzultace každý měsíc – tvoje otázky zodpovězené",
      "Sleva 10 % na osobní lekce, konzultace i kurzy",
    ],
  },
  {
    id: "mp3",
    ...
    features: [
      "Vše z VIP",
      "Přímý chat se mnou – osobní odpovědi na tvůj pohyb",
      "VIP+ Klub a kruhy – komunita lidí, co řeší totéž (+ buddies)",
      "Prioritní rezervace termínů",
      "Předběžný přístup k novým videím i kurzům",
      "Sleva 15 % na vše (lekce, konzultace, kurzy, workshopy)",
    ],
  },
];
